...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Sensor plot"))
        self.pButton_Stop.setText(_translate("MainWindow", "End acquisition"))
        self.pButton_Start.setText(_translate("MainWindow", "Begin acquisition"))
        self.sBox_Samples.setSuffix(_translate("MainWindow", " samples"))
        self.sBox_Samples.setPrefix(_translate("MainWindow", "Display "))
        self.chBox_export.setText(_translate("MainWindow", "Export to .csv file"))
